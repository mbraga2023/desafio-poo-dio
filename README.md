...
<h2>Atualizações</h2>
<ul>
<li>Adicionado um menu na classe Main para interação do usuário.</li>
<li>Adicionada uma imagem UML para melhor compreensão da estrutura do projeto.</li>
<li>Introduzido um pacote Service para encapsular a lógica de negócios.</li>
</ul>

<h3>Atualizações na Classe Dev</h3>
    <ul>
        <li>Adicionado o campo <code>bootcampsInscritos</code> para rastrear os Bootcamps nos quais o Dev está inscrito.</li>
    </ul>

<h3>Atualizações na Classe Bootcamp</h3>
    <ul>
        <li>Ajustado o método <code>toString()</code> para exibir apenas os títulos dos Cursos dentro de <code>conteudos</code>.</li>
    </ul>

<h2>Observações</h2>
    <p>Verifique as implementações dos métodos <code>toString()</code> das classes <code>Dev</code> e <code>Bootcamp</code> para garantir a formatação atualizada.</p>

<h2>Imagem UML do Projeto</h2>
<img class="uml-image" src="diagramaUML.png" alt="Diagrama UML do Projeto">
